...
# Vai ser o comprimento total - a quantidade de vezes que aparece espaço
# lembrando que os espaços iniciais e finais já foram removidos no strip
...
# Outra forma:
# separa = n.split()
# print('Seu 1º nome é {} e ele tem {} letras'
